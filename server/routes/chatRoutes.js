  ...
  router.get('/search', async (req, res) => {
    try {
      ...
      if (userType === 'resident') {
        ...
        searchConditions.isEmailVerified = true; // Only return verified residents
      ...
      console.log('Search results:', users.length, users.map(u => ({ _id: u._id, name: u.name, isEmailVerified: u.isEmailVerified })));
      res.json(users);
    } catch (error) {

...
// // GET /api/issues - Fetch all open general issues for the user's society
...
//     const staff = await Staff.findById(userId);
//     const isReporter = issue.reporterUser.toString() === userId;
...
//       description,
//       reporter,
//       reporterUser: req.userId, // Always set reporterUser
//       role,
//       society,
//       issueType,
//       image: imageData,
...
//       issue.resolvedAt = null;
//     }
//     await issue.save({ validateBeforeSave: false }); // Skip validation to avoid reporterUser error

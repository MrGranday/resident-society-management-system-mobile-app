...
//     // Test alert to confirm Alert works
...
//       Alert.alert('Error', `Blocked self-request: You cannot send a chat request to yourself.`);
//       return;
//     }
...
//       Alert.alert('Error', `Blocked duplicate request: A chat request is already pending with this user.`);
//       return;
//     }
...
//       Alert.alert('Error', `Blocked request: You already have an active chat with this user.`);
//       return;
//     }
...
//               // Simplified style prop to avoid JSX parsing error
//               const messageStyle = [
